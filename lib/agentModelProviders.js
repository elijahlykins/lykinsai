...
async function callOpenAi({ model, system, user, images, schema, maxTokens, effort, name, signal, provider = 'openai' }) {
...
export async function callStructured({
  ...
  const args = { model, system, user, images, schema, maxTokens, effort, name, signal };
