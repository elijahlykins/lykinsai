...
export const MODEL_PRICING = {
  // OpenAI
  // GPT-6 Astra (OpenRouter Sep 4, 2026): $10/$50 per M, cached input $1/M.
  // Priciest model in this table — 2x Sol in, ~1.7x out. Pro is the same
  // underlying model served with reasoning.mode=pro.
  'gpt-6-astra':       { input: 0.010,  output: 0.050, cachedInput: 0.001 },
  'gpt-6-astra-pro':   { input: 0.010,  output: 0.050, cachedInput: 0.001 },
  ...
  'claude-fable-5.1':             { input: 0.010, output: 0.050, cachedInput: 0.001 },
