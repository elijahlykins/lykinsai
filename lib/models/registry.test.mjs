...
test('openrouter id convention maps vendors correctly', () => {
  assert.equal(openRouterIdFor('openai', 'gpt-6-astra'), 'openai/gpt-6-astra');
  assert.equal(openRouterIdFor('openai', 'gpt-6-astra-pro'), 'openai/gpt-6-astra-pro');
  assert.equal(openRouterIdFor('anthropic', 'claude-fable-5.1'), 'anthropic/claude-fable-5.1');
  assert.equal(openRouterIdFor('anthropic', 'claude-fable-5-1'), 'anthropic/claude-fable-5.1');
  assert.equal(getModel('claude-fable-5.1').openRouterId, 'anthropic/claude-fable-5.1');
  assert.equal(getModel('gpt-6-astra').openRouterId, 'openai/gpt-6-astra');
