 ...
 * payer:
 *   1. internal unlimited-usage accounts → $0
...
/**
 * One decision for one action: is it exempt (internal unlimited accounts),
 * what does it cost raw, and who pays. Used by authorizeMeteredUsage.
 */
export function quoteAndChoosePayer({
  ...
  const included = isIncludedSubscriptionUsage({ unlimitedUsage });
