...
const PRICE_ENV = Object.freeze({
  ...
  proPlusMonthly: 'STRIPE_PRICE_PRO_PLUS_MONTHLY',
  proPlusAnnual: 'STRIPE_PRICE_PRO_PLUS_ANNUAL',
...
const ACTIVE_PRICE_KEYS = Object.freeze([
  ...
  ['proPlusMonthly', 'missing_pro_plus_monthly', 'pro_plus_monthly_not_a_price_id'],
  ['proPlusAnnual', 'missing_pro_plus_annual', 'pro_plus_annual_not_a_price_id'],
