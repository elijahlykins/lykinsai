...
export function mintMcpApprovalToken({ userId, connectionId, toolName, args, consequence } = {}) {
  prune();
...
export function consumeMcpApprovalToken(token, { userId, connectionId, toolName, args } = {}) {
  prune();
