export const RESPONSE_LENGTH_OPTIONS = [
  ...
  },
  {
    id: 'medium',
    label: 'Balanced',
    hint: 'Developed answers with reasoning, specifics, and an example when it helps.',
  },
  {
    id: 'detailed',
    label: 'Detailed',
...
export function formatResponseLengthPromptNote(responseLength) {
  ...
  if (id === 'detailed') {
    return '[RESPONSE_LENGTH]\nThe user set response length to DETAILED. This is a hard length setting. Write a thorough, in-depth answer with headings, lists or checklists, examples, trade-offs, and specifics. Typical replies are 500-900 words. Never compress this to a summary.';
  }
  return '[RESPONSE_LENGTH]\nThe user set response length to BALANCED. This is a hard length setting. Write a developed answer with real reasoning, relevant specifics, and an example where it helps. Use headings, lists, or a checklist instead of a wall of paragraphs when the answer has parts. Typical replies are 250-500 words. Do NOT compress an answer into one or two sentences. A greeting can stay short. A yes/no or one-word confirmation can stay short. Who you are / what model you are can stay short. Everything else is developed - including simple questions, definitions, and capability asks.';
}
