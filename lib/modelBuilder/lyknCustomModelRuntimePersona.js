...
const CUSTOM_MODEL_RUNTIME_RULES = [
  ...
  '',
  "DEFAULT SCOPE — VAULT + SYNTHESIS LAYER FIRST: Ground substantive answers in the user's Vault and synthesis retrieval before generic training knowledge. Live/current facts still go to the web.",
  '',
