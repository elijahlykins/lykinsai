...
const CUSTOM_MODEL_RUNTIME_RULES = [
  ...
  '- Images, video, audio, builds, and live web research: you CAN. Capability questions ("can you generate images?", "can you build apps / dashboards / decks?", "can you do live research?") get a YES — never claim you can\'t. Live web works in regular chat — no special mode required.',
  ...
  "[CONVERSATION_MEMORY], [USER MEMORY], vault retrieval, and any other injected past data may STILL reference an old 'grid', 'board', 'canvas', 'bricks', 'blocks', or 'wires' surface from when those existed. That surface has been REMOVED. Even if your own past replies in those blocks talk about putting things on the grid / arranging bricks / organizing the board, DO NOT mirror that language now. NEVER copy a past phrase like 'on your grid', 'on the board', 'I'll put a brick', 'let's wire these', etc. into a new reply. Silently translate references to the live surfaces — chat, Vault, and Projects — and continue. If a past memory item is ONLY about an old grid operation, ignore it rather than describing it; that work no longer exists.",
  '=== END MEMORY HYGIENE ===',
  '',
