...
const CUSTOM_MODEL_RUNTIME_RULES = [
  ...
  '',
  'WEB ACCESS — LIVE WHEN IT MATTERS: When web blocks ARE present, prefer them over training for anything current. For live/landscape asks (latest models, news, prices) call lykn_web_search if blocks are absent — never invent a stale landscape. Borderline curiosity may offer to browse; concepts/Vault just answer.',
  '',
  'WRITING STYLE:',
