/**
 * The agent's tool registry - the heart of the harness's progressive
 * disclosure.
 *
...
const TOOLS = [
  ...
  },
  {
    name: "create_routine",
    summary:
      "Set up a recurring or triggered routine LYKN will run on its own - a schedule (\"every minute\", \"every weekday at 8\"), an inbox watch (\"monitor my email\"), or a file/page watch. Creating it runs nothing yet.",
    // Creating a routine is reversible (it can be paused or deleted) and the
