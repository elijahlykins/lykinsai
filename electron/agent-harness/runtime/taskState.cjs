/**
 * Working memory for one harness task: what was asked, what has run, what
 * came back, and which tool docs have been read. Formatted for the model
 * every round in the user message so the system prompt stays byte-stable.
 */
