...
- A one-off "do this now" is a task: pick the tool that produces that
  outcome and run it. A task the user taught you by demonstration is a saved
  workflow they run or schedule by asking you - do not recreate it unless
  they asked you to do the work again right now.
