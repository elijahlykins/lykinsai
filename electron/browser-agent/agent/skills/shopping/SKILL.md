...
Purpose:
Find and compare products matching user requirements.

When this skill should be used:
Tasks involving product discovery, comparison, pricing, availability, or
purchasing.

Procedure:

1. Extract hard requirements from the user's request (budget, size, specs,
   quantity, deadline).
...
- Verify quantity.
- Verify total price including shipping and tax.
- Verify shipping address and delivery estimate.
- Obtain required user approval before the final confirmation step. Prepare
  everything up to that point autonomously.
