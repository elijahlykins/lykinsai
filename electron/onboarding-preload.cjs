...
// (Screen Recording, Microphone, Accessibility, Apple Events), and a
// hotkey-pressed signal for the final "try ⌘L" step.
...
contextBridge.exposeInMainWorld("lyknOnboarding", {
  ...
  // ── Try it ───────────────────────────────────────────────────────────
  // Fires when the user presses the global ⌘L while this window is open.
