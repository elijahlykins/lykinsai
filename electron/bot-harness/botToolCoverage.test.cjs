...
const registry = require("../bot-harness/runtime/toolRegistry.cjs");
const instructions = require("../bot-harness/runtime/instructions.cjs");
...
const contextRouter = require("../bot-harness/runtime/contextRouter.cjs");
const taskState = require("../bot-harness/runtime/taskState.cjs");
