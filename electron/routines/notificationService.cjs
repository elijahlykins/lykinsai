...
/**
 * The ONE notification service — every Routine / Task notification
 * flows through here. Executors do not build their own.
 *
 * V1 destinations:
 ...
 * link carries identity (routineId / taskId / runId), never content.
 */
...
function createNotificationService({
   ...
   *
   * @param {object} input
   *   { routineId?, runId?, taskId?, title, body, urgency?, policy?,
