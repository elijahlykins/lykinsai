...
import type { Block, BlockId, Camera, LegacyListItem, LegacyListType, TextBlock, TextFormat } from "@/lyknChat/types";
import { snapToGrid } from "@/lyknChat/utils/snap";
import { migrateLegacyBlocks } from "@/lyknChat/utils/migrateBlocks";
import { extractYouTubeVideoId } from "@/lib/media/youtube";
import type { UniversalBlockConnection, UniversalBlockRuntime } from "@/lyknChat/blockSystem/types";
import type { BrickTrait } from "@/lyknChat/blockSystem/types";
...
export const useLyknChatStore = create<CanvasState>()(
  immer((set, get) => ({
    blocks: {},
    blockOrder: [],
    selectedIds: [],
