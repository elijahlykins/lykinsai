...
import OmniaVoiceModeEleven from "./OmniaVoiceModeEleven";
import VoiceTechOrb from "./VoiceTechOrb";

interface OmniaVoiceModeProps {
  open: boolean;
  onClose: () => void;
  boardId?: string | null;
  voice?: string;
...
export default function OmniaVoiceMode(props: OmniaVoiceModeProps) {
  ...
  if (isElevenLabsVoice) {
    return <OmniaVoiceModeEleven {...props} />;
  }
