...
export type OmniaScopedProject = { id: string; name: string };

export type OmniaProjectPickerProps = {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  userId?: string;
  activeProjectId?: string | null;
  onSelect: (project: OmniaScopedProject | null) => void;
};
...
const OmniaProjectPicker = React.memo(function OmniaProjectPicker({
  open,
  onOpenChange,
  userId,
  activeProjectId,
  onSelect,
}: OmniaProjectPickerProps) {
  ...
  const pick = React.useCallback(
    (project: OmniaScopedProject | null) => {
      onSelect(project);
      onOpenChange(false);
    },
...
export default OmniaProjectPicker;
