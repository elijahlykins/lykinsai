...
export default function AgentBuildCodePanel({
  ...
  if (!building && !display && !files.length) return null;

  return (
    <div className="rounded-2xl border border-black/[0.08] dark:border-white/[0.10] bg-[#0d1117] overflow-hidden">
      ...
      <pre
        ref={scrollRef}
        className="max-h-[min(42vh,320px)] overflow-auto p-3 text-[11px] leading-relaxed text-emerald-100/90 font-mono scrollbar-hide"
      >
