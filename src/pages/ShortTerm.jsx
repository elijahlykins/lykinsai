...
import { Clock, Trash2, Edit2, Save, XCircle } from 'lucide-react';
...
export default function ShortTermPage() {
  ...
  const filteredNotes = notes.filter(note => note.storage_type === 'short_term');
