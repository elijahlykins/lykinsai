...
/** Free-text tone from draft/API; legacy preset ids map to their hint text. */
...
/**
 * Rebuild ## Response style from Basics behavior controls.
 */
...
/** Same strings the main chat API uses for responseLength. */
