...
export const searchVaultTool = {
  ...
  description: [
    ...
    'Follow up with read_document / lykn_loadNeuron using node_id when the',
    ...
    '`lykn_loadNeuron({ node_id })` — or `lykn_loadNeurons` for several —',
    'using the `node_id` field from the hit.',
    '',
