...
export const delegateToSubModelTool = {
  ...
  description: [
    ...
    '',
    'WHEN TO CALL:',
    '  • The work needs a specialist on your roster and you cannot finish it yourself.',
    '  • The user named that sub-agent, or the task is implement / refactor / debug',
    '    a codebase or another long loop that specialist owns.',
    '',
    'WHEN NOT TO CALL:',
    '  • Folder/file listings, summaries, explanations, and questions you can finish.',
    '  • Casual conversation or anything your own tools can complete this turn.',
