...
export const loadNeuronsTool = {
  ...
  description: [
    ...
    '  • Project members or prior vault cards gave you several vault_<uuid> ids',
    '    and the user wants to actually look at them in the chat.',
    ...
    '    the chat. Use titles from project members and concise prose instead.',
    '',
  ...
  inputSchema: {
    ...
    properties: {
      node_ids: {
        type: 'array',
        description: `Array of vault_<uuid> node_ids. Capped at ${MAX_BATCH}.`,
