...
const SERVER_INSTRUCTIONS = [
  'This server exposes how LYKN knows the user — three memory buckets:',
  '  • WHO_I_AM — beliefs, rules, preferences, identity facts (keep learning;',
  '    update when they contradict stale facts via lykn_proposeFact / tools)',
  '  • WHAT_IM_ON — projects + working state (connect the current topic to',
  '    the best-fit project; they may have several)',
  '  • WHAT_IVE_SAVED — Vault (lykn_searchVault when they need something saved)',
  '',
  ...
  'Treat [WHO_I_AM] beliefs/rules as binding governance; connect work to',
  '[WHAT_IM_ON]; pull Vault only when needed.',
  '',
  'During the conversation, write back when it earns its keep:',
  '  • Call `lykn_recordRuleApplication` when you follow a returned rule.',
  '  • Call `lykn_pushProjectState` when the conversation produces a durable',
  '    project decision (so the next client picks up where this one left off).',
  '  • Call `lykn_proposeFact` when you learn a new preference/fact, or when',
  '    they contradict something you thought you knew.',
  '',
  'Beliefs are USER-AUTHORED ONLY — do NOT invent new core beliefs. Facts and',
  'preferences may be proposed and updated. Read beliefs via getContextBlock',
  '/ getBeliefs.',
  '',
  'Use finer-grained tools (lykn_getBeliefs / lykn_getRules /',
  'lykn_getProjectState / lykn_searchVault / lykn_getFacts) mid-conversation',
  'when needed. For the upfront load, getContextBlock is enough.',
].join('\n');
