...
Remaining inline after Wave 5 (42 routes): billing ×9, the five pre-limiter platform routes, chat core ×5 (`/api/ai/models`, stream-guest, invoke, local-tool-result, stream), the learning/user-model band ×21 (MEMORY-REPLACEMENT CANDIDATE), and discover ×2 (legacy-adjacent). All services, pollers, and global middleware also stay in bootstrap.
